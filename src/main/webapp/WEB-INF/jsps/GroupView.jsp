...
<div class="container">
	...
	<div class="panel">
		<table id="projectTable"
			...
			<thead>
				<tr>
					...
					<th class="col-md-2 col-sm-2 col-xs-2">Group Title</th>
        ...
        <tr>
            ...
            <td> <a href="${pageContext.request.contextPath}/projectFileView?groupId=${groups.getGroupId()}&groupName=${groups.getGroupName()}&projectTitle=${groups.getProjectTitle()}"> <c:out value="${groups.getGroupName()}"/></td>
            <td> <c:out value="${groups.getProjectTitle()}"/></a></td>        
        </tr>
    </c:forEach>
			</tbody>
		</table>
